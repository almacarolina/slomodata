...
ax.axhline(y=0, color='k',linestyle='solid', lw=2, alpha=0.8)
ax.axvline(x = fi3, color='k',linestyle='solid', lw=2, alpha=1)
ax.axvline(x = fi4, color='k',linestyle='solid', lw=2, alpha=1)
ax.axvline(x = fi5, color='k',linestyle='solid', lw=2, alpha=1)
...
ax.text(735968-11, 11.8, centerify("NW"), fontsize=13) # 86
ax.text(735968-23-11, 10.3, centerify("monsoon"), fontsize=13) #77
ax.text(736152-3-2, 11.8, centerify("SE"), fontsize=13)
ax.text(736152-23-9-2, 10.3, centerify("monsoon"), fontsize=13)
ax.text(736334-10-2, 11.8, centerify("NW"), fontsize=13)
ax.text(736334-23-10-2, 10.3, centerify("monsoon"), fontsize=13)
ax.text(736520-6-2, 11.8, centerify("SE"), fontsize=13)
ax.text(736520-23-12-2, 10.3, centerify("monsoon"), fontsize=13)
ax.text(736698-9, 11.8, centerify("NW"), fontsize=13)
ax.text(736698-23-9, 10.3, centerify("monsoon"), fontsize=13)
ax.text(736880-2-2, 11.8, centerify("SE"), fontsize=13)
ax.text(736880-23-8-2, 10.3, centerify("monsoon"), fontsize=13)
ax.text(737065-11-2, 11.8, centerify("NW"), fontsize=13)
ax.text(737065-23-11-2, 10.3, centerify("monsoon"), fontsize=13)
...
ax.set_ylim(-25, 30)
ax.set_ylabel('[cm]')
ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.03), ncol=4, fontsize=12)
ax.axvline(x = fi3, color='k',linestyle='solid', lw=2, alpha=1)
ax.axvline(x = fi4, color='k',linestyle='solid', lw=2, alpha=1)
ax.axvline(x = fi5, color='k',linestyle='solid', lw=2, alpha=1)
ax.text(0.02, 0.85, 'b)',
...
ax.text(736128.3107449524, -40, '2016', fontsize=18)
ax.text(736493.9222557439, -40, '2017', fontsize=18)
ax.text(736857.389417498, -40, '2018', fontsize=18)
