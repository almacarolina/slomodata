...
ax.text(735968-11, 67, centerify("NW"), fontsize=13) # 86
ax.text(735968-23-11, 55.3, centerify("monsoon"), fontsize=13) #77
ax.text(736152-3, 67, centerify("SE"), fontsize=13)
ax.text(736152-23-9, 55.3, centerify("monsoon"), fontsize=13)
ax.text(736334-10, 67, centerify("NW"), fontsize=13)
ax.text(736334-23-10, 55.3, centerify("monsoon"), fontsize=13)
ax.text(736520-6, 67, centerify("SE"), fontsize=13)
ax.text(736520-23-12, 55.3, centerify("monsoon"), fontsize=13)
ax.text(736698-9, 67, centerify("NW"), fontsize=13)
ax.text(736698-23-9, 55.3, centerify("monsoon"), fontsize=13)
ax.text(736880-2, 67, centerify("SE"), fontsize=13)
ax.text(736880-23-8, 55.3, centerify("monsoon"), fontsize=13)
ax.text(737065-11, 67, centerify("NW"), fontsize=13)
ax.text(737065-23-11, 55.3, centerify("monsoon"), fontsize=13)
...
ax.set_yticks([-25,0,25])
ax.legend(loc='lower center', frameon=True, fontsize=12, bbox_to_anchor=(0.50, -0.04), ncol=3)
