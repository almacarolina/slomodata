...
ax1.axvline(x=date2num(fi), color='k', linestyle='-',lw=2, alpha=1)
ax1.axvline(x=date2num(fi2), color='k', linestyle='-', lw=2, alpha=1)
ax1.axvline(x=date2num(fi3), color='k', linestyle='-', lw=2, alpha=1)
...
ax1.text(735968-10, 260, centerify("NW"), fontsize=13) # 86
ax1.text(735968-43, 180, centerify("monsoon"), fontsize=13) #77
ax1.text(736152-8, 260, centerify("SE"), fontsize=13)
ax1.text(736152-43, 180, centerify("monsoon"), fontsize=13)
ax1.text(736334-10, 260, centerify("NW"), fontsize=13)
ax1.text(736334-45, 180, centerify("monsoon"), fontsize=13)
ax1.text(736520-9, 260, centerify("SE"), fontsize=13)
ax1.text(736520-46, 180, centerify("monsoon"), fontsize=13)
ax1.text(736698-10, 260, centerify("NW"), fontsize=13)
ax1.text(736698-43, 180, centerify("monsoon"), fontsize=13)
ax1.text(736880-5, 260, centerify("SE"), fontsize=13)
ax1.text(736880-42, 180, centerify("monsoon"), fontsize=13)
ax1.text(737065-12, 260, centerify("NW"), fontsize=13)
ax1.text(737065-45, 180, centerify("monsoon"), fontsize=13)
fi = datetime.datetime.strptime("01-03-2016", "%d-%m-%Y")
ax1.axvline(x=date2num(fi), color='k', linestyle='--', lw=0.8, alpha=0.5)
